package com.jaycong.boot.capability.ratelimit.aspect;
...
import com.jaycong.boot.capability.ratelimit.config.RateLimitProperties;
import com.jaycong.boot.capability.ratelimit.exception.RateLimitException;
import com.jaycong.boot.capability.ratelimit.service.RateLimitService;
import com.jaycong.boot.capability.ratelimit.util.ClientIpUtils;
...
public class RateLimitAspect {
    ...
    @Around("@annotation(com.jaycong.boot.capability.ratelimit.annotation.RateLimit)")
