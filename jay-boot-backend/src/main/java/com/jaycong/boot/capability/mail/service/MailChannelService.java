...
import com.jaycong.boot.capability.mail.dto.AdminMailChannelCreateRequest;
import com.jaycong.boot.capability.mail.dto.AdminMailChannelItemView;
import com.jaycong.boot.capability.mail.dto.AdminMailChannelPageRequest;
import com.jaycong.boot.capability.mail.dto.AdminMailChannelStatusUpdateRequest;
import com.jaycong.boot.capability.mail.dto.AdminMailChannelUpdateRequest;
import com.jaycong.boot.capability.mail.entity.MailChannelEntity;
import com.jaycong.boot.capability.mail.mapper.MailChannelMapper;
import com.jaycong.boot.capability.mail.util.MailEncryptor;
...
public class MailChannelService {
    ...
    private AdminMailChannelItemView toView(MailChannelEntity entity) {
        ...
        return new AdminMailChannelItemView(
                ...
                com.jaycong.boot.capability.mail.constant.MailTlsMode.fromValue(entity.getTlsMode()),
                entity.getFromName(),
                entity.getFromEmail(),
                entity.getPriority(),
