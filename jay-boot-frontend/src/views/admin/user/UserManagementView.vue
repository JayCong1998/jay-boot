...
const toRoleValue = (value: string): AdminUserRole | null => {
...
const toStatusValue = (value: string): AdminUserStatus | null => {
...
const roleFilterOptions = computed<Array<{ label: string; value: '' | AdminUserRole }>>(() => [
  { label: '全部角色', value: '' },
...
const statusFilterOptions = computed<Array<{ label: string; value: '' | AdminUserStatus }>>(() => [
  { label: '全部状态', value: '' },
