 ...
 * 请求方式：POST
 */
export const createAdminUserApi = (payload: AdminUserCreatePayload) =>
  post<null>('/api/admin/users', payload)
 ...
 * 请求方式：POST
 */
export const updateAdminUserApi = (id: string, payload: AdminUserUpdatePayload) =>
  post<null>(`/api/admin/users/${id}`, payload)
 ...
 * 请求方式：POST
 */
export const updateAdminUserStatusApi = (id: string, status: AdminUserStatus) =>
  post<null>(`/api/admin/users/${id}/status`, { status } as AdminUserStatusPayload)
 ...
 * 请求方式：POST
 */
export const resetAdminUserPasswordApi = (id: string, newPassword: string) =>
  post<null>(`/api/admin/users/${id}/password/reset`, { newPassword } as AdminUserPasswordResetPayload)
